...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()(
  {
    head: () => ({
      meta: [
        ...
        { title: "Reve-z — Bungalows sur la lagune de Nefza" },
        {
          name: "description",
          content:
            "Reve-z, Halq El Oued Ezzouaraa : bungalows sur pilotis au-dessus de la lagune de Nefza, en demi-journée ou 24 heures.",
        },
