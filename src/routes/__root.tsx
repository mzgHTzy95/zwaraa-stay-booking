...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Zwaraa — Bungalows sur la lagune de Nefza" },
      {
        name: "description",
        content:
          "Zwaraa, Halq El Oued Ezzouaraa : bungalows sur pilotis au-dessus de la lagune de Nefza, en demi-journée ou 24 heures.",
      },
