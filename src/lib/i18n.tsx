...
const ar: Dict = {
  ...
  "slot.half_day": "نصف بونتون",
  "slot.24h": "بونتون كامل",
  ...
  "home.galleryTeaser.kicker": "المعرض",
"home.galleryTeaser.title": "اكتشف زوارة بالصور",
"home.galleryTeaser.body":
  "بنغالوهات، أنشطة، وجبات وطبيعة — استكشف معرضنا الكامل بالصور والفيديوهات.",
"home.galleryTeaser.cta": "شاهد المعرض",

  "gallery.category.bungalow": "بنغالو",
  "gallery.category.activity": "نشاط",
  "gallery.category.food": "أكل",
  "gallery.category.nature": "طبيعة",
  "gallery.about.kicker": "تجربة زوارة",
"gallery.about.title": "انغماس كامل في الطبيعة التونسية",
"gallery.about.body":
  "زوارة تقع في نفزة، شمال غرب تونس، وتقدم تجربة فريدة: النوم في بنغالو على الماء مباشرة. سواء لنصف يوم أو ليلة كاملة، كل إقامة تشمل وجبات محلية ونزهات بالقارب لاكتشاف جمال المنطقة الطبيعي.",
"gallery.about.statLagoon": "إطلالة البحيرة",
"gallery.about.statBungalows": "بنغالوهات",
"gallery.included.title": "ما يشمله إقامتك",
"gallery.included.meals.title": "وجبات محلية مشمولة",
"gallery.included.meals.body":
  "كل حجز يشمل وجبات مُحضّرة بمنتجات محلية، تُقدَّم مباشرة في البنغالو الخاص بك أو على ضفاف البحيرة.",
"gallery.included.boat.title": "نزهة بالقارب",
"gallery.included.boat.body":
  "استكشف البحيرة على متن قارب تقليدي برفقة مرشدينا المحليين — مشمولة في كل باقة.",
"gallery.included.lagoon.title": "إطلالة كاملة على البحيرة",
"gallery.included.lagoon.body":
  "يمنحك البنغالو المبني على الماء وصولاً مباشراً إلى المياه العذبة للبحيرة، بين النهر والبحر الأبيض المتوسط.",
"gallery.included.booking.title": "حجز بسيط وآمن",
"gallery.included.booking.body":
  "احجز وادفع عبر الإنترنت في دقائق معدودة، مع تأكيد فوري ودون أي رسوم خفية.",
"gallery.filter.all": "الكل",
"gallery.filter.empty": "لا توجد صور في هذه الفئة حالياً.",
"gallery.reserveThis": "احجز هذا البنغالو",
"lightbox.position": "صورة {current} من {total}",
"lightbox.play": "تشغيل تلقائي",
"lightbox.pause": "إيقاف مؤقت",
  ...
  "book.adults": "بالغون",
  "book.children6_10": "أطفال 6–10 سنوات",
  "book.childrenUnder5": "أطفال أقل من 5 سنوات",
  "book.childrenNote": "أطفال 6–10 سنوات: 50 دت · أقل من 5: مجاناً",
  "receipt.downloadWarning": "حمّل أو اطبع هذا الوصل — ستحتاجه عند وصولك إلى البنغالو.",
  "gallery.title": "معرض البنغالوهات",
  "gallery.subtitle": "اكتشف تفاصيل كل بنغالو على الركائز.",
  ...
  "receipt.saveModalBody": "سنحمّل صورة لوصلك تلقائيًا. احتفظ بها — ستحتاجها عند وصولك إلى البنغالو.",
  "receipt.saveModalDownload": "تحميل الوصل مرة أخرى",
  "receipt.saveModalClose": "لقد حفظت النسخة",
  "admin.title": "الإدارة",
